		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
				<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				  	<img src="<?= $randomcategory_logo; ?>" class="card-img-top" alt="..." style="height: 150px;">
				  	<div class="card-body">
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad20">
					        	<a href="details.php?id=<?= $si_id ?>"><img src="<?= $si_photo ?>" class="img-fluid" style="height: 150px; width: 200px;"></a>
								...
								<a href="#" class="addtocartBtn text-decoration-none" style="background-color: #ef3b68; color: #ff"
									data-id="<?= $si_id ?>" data-name="<?= $si_name ?>" 
									data-price="<?= $si_price ?>" 
									data-discount="<?= $si_discount ?>" 
									data-photo="<?= $si_photo ?>" 
									data-codeno="<?= $si_codeno ?>">
										Add to Cart
									</a>
		                    </div>
		                </div>
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad20">
					        		<a href="details.php?id=<?= $ri_id ?>"><img src="<?= $ri_photo ?>" class="img-fluid" style="height: 150px; width: 200px;"></a>
								...
								<a href="#" class="addtocartBtn text-decoration-none" style="background-color: #ef3b68; color: #ff"
									data-id="<?= $ri_id ?>" data-name="<?= $ri_name ?>" 
									data-price="<?= $ri_price ?>" 
									data-discount="<?= $ri_discount ?>" 
									data-photo="<?= $ri_photo ?>" 
	    	...
	    	?>
	      	<div class="slide">
	      		<a href="brand.php?id=<?= $bid ?>">
		      		<img src="<?= $blogo ?>" style="height: 100px; width: 120px;">
		      	</a>
	      	</div>
