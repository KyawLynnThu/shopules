...
<div class="row user">
        <div class="col-md-12">
          <div class="profile">
            <div class="info"><img src="image/rose.jpg">
              <h4><?= $_SESSION['login_user']['name']; ?></h4>
              <p><?= $_SESSION['login_user']['rname']; ?></p>
            </div>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="user-timeline">
              <div class="timeline-post">
                <div class="post-media"><a href="#"><img src="image/rose.jpg" style="width: 50px; height: 50px; border-radius: 50%;"></a>
                  <div class="content">
                    <h5><a href="#"><?= $_SESSION['login_user']['name']; ?></a></h5>
              ...
              <div class="timeline-post">
                <div class="post-media"><a href="#"><img class="user-img" src="image/rose.jpg" style="width: 50px; height: 50px; border-radius: 50%;"></a>
                  <div class="content">
                    <h5><a href="#"><?= $_SESSION['login_user']['name']; ?></a></h5>
                    <p class="text-muted"><small>2 January at 9:30</small></p>
                  </div>
