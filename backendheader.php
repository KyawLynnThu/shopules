<?php 
    ...
    if(!isset($_SESSION['login_user'])) {
        $_SESSION['login_fail'] = 'You are not logged in. Please log in to continue.';
            ...
            <ul class="app-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li>
                        <a class="dropdown-item" href="backendprofile.php">
       ...
       <aside class="app-sidebar">
            <div class="app-sidebar__user">
                <div style="margin: 0 auto;">
                    <a href=""><img src="image/rose.jpg" style="width: 50px; height: 50px; border-radius: 50%;"></a>
